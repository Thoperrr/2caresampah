<div id="assignModal" class="fixed inset-0 bg-black/30 backdrop-blur-sm hidden justify-center items-center z-50">
    <div class="bg-white rounded-lg w-full max-w-md p-6 shadow-lg">
        <h2 class="text-xl font-semibold mb-4">Jadwalkan Penjemputan</h2>

        <form action="{{ route('admin.pickup.assign') }}" method="POST">
            @csrf
            <input type="hidden" name="pickup_request_id" id="pickupRequestId">

            <div class="mb-4">
                <label class="block mb-1 text-gray-700">Pilih Petugas</label>
                <select name="petugas_id" class="w-full border border-gray-300 rounded px-3 py-2">

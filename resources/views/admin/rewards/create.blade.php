...
@section('content')
    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        <main class="flex-1 p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800">Add New Reward</h1>
                <p class="text-gray-600">Create a new reward option for users</p>
            </div>
                ...
                <form action="{{ route('admin.rewards.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="number" name="points_required" id="points_required"
                                value="{{ old('points_required') }}" min="1" step="1"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="cash_value" id="cash_value" value="{{ old('cash_value') }}" min="0"
                                step="100"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateStatus() {
                statusText.textContent = toggleSwitch.checked ? 'Active' : 'Inactive';
            }
